...
|build badge|_ |coverage badge|_

.. |build badge| image:: https://travis-ci.org/posita/py-dimgx.svg?branch=master
.. _`build badge`: https://travis-ci.org/posita/py-dimgx

.. |coverage badge| image:: https://coveralls.io/repos/posita/py-dimgx/badge.svg
.. _`coverage badge`: https://coveralls.io/r/posita/py-dimgx
...
``dimgx`` (pronounced *DIH-muhj-EHKS* [#pronunciation]_) is a pure Python module and command line tool for selecting and extracting `Docker <https://www.docker.com/whatisdocker/>`_ `image <https://docs.docker.com/terms/image/>`__ `layers <https://docs.docker.com/terms/layer/>`__ and flattening them into a single tar archive.
...
``dimgx`` has been tested with cPython versions 2.7 and 3.4 as well as PyPy.

License
-------

This software is licensed under the `MIT License <http://opensource.org/licenses/MIT>`_.
See the accompanying |LICENSE|_ (or |LICENSE.txt|_) file for details.
...
Be sure to also check out Jason Wilder's |docker-squash|_, which probably has more features and is likely more mature.
